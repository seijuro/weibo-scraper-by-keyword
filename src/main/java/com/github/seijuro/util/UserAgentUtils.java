package com.github.seijuro.util;

import com.sun.javafx.PlatformUtil;

public class UserAgentUtils {
    public static class Chrome {
        static String pick(String[] userAgents) {
            int length = userAgents.length;
            int selected = (int)(Math.random() * (length - 1));
            return userAgents[selected];
        }

        public static final String OPT_USER_AGENT = "--user-agent=";

        public static String getChromeOptionString() {
            return OPT_USER_AGENT + getRandomUserAgentString();
        }

        public static String getRandomUserAgentString() {
            if (PlatformUtil.isMac()) {
                return pick(MacUserAgents);
            }

            if (PlatformUtil.isLinux()) {
                return pick(LinuxUserAgents);
            }

            if (PlatformUtil.isWindows()) {
                return pick(WindowsUserAgents);
            }

            throw new RuntimeException("Not supported OS Platform.");
        }

        static String[] LinuxUserAgents = new String[]{
        ...
        static String[] MacUserAgents = new String[]{
        ...
        static String[] WindowsUserAgents = new String[]{
                ...
                "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.116 Safari/537.36	52",
                ...
                "Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2623.112 Safari/537.36	49",
